...
SCENARIOS = {
    ...
    # Updated Forest Scenario with new text
    "forest_1": {
        "title": "Сценарій 4 — Ти загубився в лісі",
        "description": "Ти пішов у похід і втратив орієнтацію. Навколо ліс. Починає сутеніти.",
        "question": "Крок 1: Як діяти?",
        "options": [
            ("A) Продовжуєш іти далі, поки видно.", "forest_1_wrong"),
            ("Б) Робиш позначку, шукаєш укриття.", "forest_2"),
            ("В) Кричиш і кличеш на допомогу.", "forest_1_wrong"),
        ],
        "explanation": "Краще залишитися на місці та зробити тимчасовий табір."
    },
    "forest_1_wrong": {
        "title": "Неправильний вибір",
        "description": "На жаль, це не найкраще рішення у лісі.",
        "options": [
    ...
    "forest_2": {
        "title": "Добре рішення!",
        "description": "Краще залишитися на місці та зробити тимчасовий табір.",
        "question": "Крок 2: У тебе є ніж, сірники, пляшка води. Що робиш?",
        "options": [
            ("A) Палиш вогонь і робиш сигнал диму.", "forest_2_wrong"),
            ("Б) Розбиваєш табір, залишаєш вогонь.", "forest_3"),
            ("В) Ідеш далі з надією на вихід.", "forest_2_wrong"),
        ],
        "explanation": "Ніч у лісі — небезпека. Вогонь дає тепло і захист."
    },
    "forest_2_wrong": {
        "title": "Неправильний вибір",
        "description": "На жаль, це не найкраще рішення у лісі.",
    ...
    "forest_3": {
        "title": "Добре рішення!",
        "description": "Вогонь дає тепло і захист.",
        "question": "Крок 3: На ранок — що далі?",
        "options": [
            ("A) Ідеш уздовж річки.", "forest_result"),
            ("Б) Залізеш на дерево — оглянути місцевість.", "forest_3_wrong"),
            ("В) Чекаєш рятувальників.", "forest_3_wrong"),
        ],
        "explanation": "Вода веде до людей. Це класичний орієнтир у природі."
    },
    "forest_3_wrong": {
        "title": "Неправильний вибір",
        "description": "На жаль, це не найкраще рішення у лісі.",
    ...
    "forest_result": {
        ...
        "description": (
            "Вітаємо! Ти набрав 3 бали: успішно вижив у лісі, дочекався порятунку.\n\n"
            "Ти зробив правильні кроки:\n"
            "1. Залишився на місці та облаштував тимчасовий табір\n"
            "2. Розпалив вогонь, щоб отримати тепло і захист\n"
            "3. Обрав правильний напрям руху — уздовж річки, що веде до людей"
        ),
        "options": [
            ("🏠 До головного меню", "start"),
